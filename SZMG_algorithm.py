...
<style type="text/css">
<body { font-family:'MS Shell Dlg 2'; font-size:9.5pt; font-weight:400; font-style:normal; }>
<p { margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; }>
</style>
</head>
<body>
<p><strong>Seismic Zones with morphological gradient (SMG)</strong></p>
<p>The morphological gradient in seismic areas with slopes greater than 15° can influence the propagation of seismic waves, amplifying their energy and increasing the risks of landslides or ground subsidence. This plugin identifies areas with a morphological gradient with slopes ≥15° within seismic zones (Input vector file) starting from the DTM</p>
<p>Useful Link: Guidelines For Seismic Microzonation (document available at centromicrozonazionesismica.it)</p>
<br/>
<p align="right">Version: 0.4 20260209</p>
</body>
</html>"""
